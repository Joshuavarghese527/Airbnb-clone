class ReservationsController < ApplicationController
  ...
  def create
    ...
    if @reservation
      ...
      values = {
        business: 'joshuavarghese27-facilitator@gmail.com',
        cmd: '_xclick',
        upload: 1,
        notify_url: 'https://rental-estates.herokuapp.com/notify',
        amount: @reservation.total,
        item_name: @reservation.room.listing_name,
        item_number: @reservation.id,
        quantity: '1',
        return: 'https://rental-estates.herokuapp.com/your_trips'
      }
